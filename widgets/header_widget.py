...
class HeaderWidget(TurnsBoxWidget):
    ...
    def _add_widgets(self, layout: QHBoxLayout) -> None:
        layout.addStretch(5)
        # layout.addWidget(self.turns_box.turns_panel.filter_tab.section.rot_dir_button_manager.same_button)
        layout.addStretch(1)
        layout.addWidget(self.header_label)
        layout.addStretch(1)
        # layout.addWidget(self.turns_box.turns_panel.filter_tab.section.rot_dir_button_manager.opp_button)
        layout.addStretch(5)
