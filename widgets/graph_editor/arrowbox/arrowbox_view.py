...
class ArrowBoxView(QGraphicsView):
    def __init__(self, arrowbox: 'ArrowBox') -> None:
        ...
        self.setFrameStyle(QFrame.Shape.Box | QFrame.Shadow.Plain)  # Add black line around the frame
    ...
    def resizeEvent(self, event) -> None:
        ...
        if self.scene():
            ...
            self.scale(self.width() / self.scene_width *2, self.width() / self.scene_width *2)
