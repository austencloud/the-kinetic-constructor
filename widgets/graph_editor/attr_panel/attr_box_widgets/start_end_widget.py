...
class StartEndWidget(QWidget):
    def __init__(
        ...
        self.swap_button.setFixedSize(
            int(combo_box_height / 2), int(combo_box_height / 2)
        )
        ...
        self.spacer_item.setFixedHeight(int(combo_box_height / 2))
        self.spacer_item.setFixedWidth(int(combo_box_height / 2/2))

        self.spacer_layout = QVBoxLayout()
        self.spacer_layout.addWidget(self.spacer_item)
