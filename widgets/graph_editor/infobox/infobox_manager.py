...
class InfoboxManager:
    def __init__(self, infobox):
        ...
        self.updater = InfoboxUpdater(self.infobox.main_widget, self.infobox.graphboard_view)
        ...
        self.state_manager = InfoboxUpdater(self.infobox.main_widget, self.infobox.graphboard_view)
