...
class SR_CaptureFrame(QFrame):
    def __init__(self, sequence_recorder: "SequenceRecorder") -> None:
        ...
        self.sequence_widget_beat_frame = SR_BeatFrame(self)
    ...
    def _setup_layout(self) -> None:
        ...
        self.layout.addWidget(self.sequence_widget_beat_frame, 1)
    ...
    def start_recording(self) -> None:
        self.recording = True
        self.sequence_widget_beat_frame.start_recording()
    ...
    def stop_recording(self) -> None:
        ...
        self.recording = False
        self.beat_video_path = self.sequence_widget_beat_frame.stop_recording()
    ...
    def resize_capture_frame(self) -> None:
        ...
        self.sequence_widget_beat_frame.setFixedSize(size, size)
        self.sequence_widget_beat_frame.resize_beat_frame()
