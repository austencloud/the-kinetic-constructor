...
class UserManager(QObject):
    def __init__(self, user_profile_settings: "UserProfileSettings"):
        ...
        self.previous_user = ""
        self.user_combo_box: QComboBox = None
        self.user_menu_bar = None

    def populate_user_profiles(self):
        user_profiles: dict[str, dict] = self.user_profile_settings.settings.get("user_profiles", {})
        current_user = self.get_current_user()
        if self.user_combo_box:
            self.user_combo_box = self.user_combo_box
        ...
        # update the menu bar to reflect hte changes
