...
class TurnDisplayManager:
    ...
    def set_turn_display_styles(self) -> None:
        self.turns_display_font_size = int(self.turns_box.turns_panel.width() / 34)
    ...
    def resize_turn_display(self) -> None:
        self.turns_display.setMinimumHeight(
            int(self.turns_box.turns_panel.width() / 18)
        )
        self.turns_display.setMaximumHeight(
            int(self.turns_box.turns_panel.width() / 18)
        )
        self.turns_display.setMinimumWidth(int(self.turns_box.turns_panel.width() / 14))
        self.turns_display.setMaximumWidth(int(self.turns_box.turns_panel.width() / 14))
    ...
    def calculate_adjust_turns_button_size(self) -> int:
        return int(self.turns_box.turns_panel.width() / 25)
