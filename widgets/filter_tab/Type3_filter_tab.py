...
from widgets.attr_panel.motion_type_attr_panels.Type2_motion_type_attr_panel import Type2MotionTypeAttrPanel
...
class Type3FilterTab(BaseFilterTab):
    ...
    def setup_ui(self) -> None:
        super().setup_ui()
        self.motion_type_attr_panel = Type3MotionTypeAttrPanel(
        ...
        self.tabs: List[
            Type3MotionTypeAttrPanel | ColorAttrPanel | LeadStateAttrPanel
        ] = [
