...
if TYPE_CHECKING:
    ...
    from ...letterbook_turns_widget import LetterBookTurnsWidget


class LetterBookTurnsWidgetDisplayManager:
    def __init__(self, turns_widget: "LetterBookTurnsWidget") -> None:
        self.turns_widget = turns_widget
        self.turns_box: LetterBookTurnsBox = turns_widget.turns_box
