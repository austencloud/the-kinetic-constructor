...
class LetterBookPropRotDirButtonManager:
    ...
    def _setup_prop_rot_dir_buttons(self) -> list[QPushButton]:
        button_factory = (
            self.turns_box.turns_panel.turns_tab.section.scroll_area.letterbook.main_widget.button_factory
        )
    ...
    def update_visibility_based_on_motion(
        self, new_turns, attribute_value: Union[str, MotionType, LeadStates]
    ) -> None:
