...
from .letterbook_prop_rot_dir_button_manager import (
    LetterBookPropRotDirButtonManager,
)
from ...letterbook_turns_widget import (
...
class LetterBookTurnsBox(QFrame):
    turns_widget: LetterBookTurnsWidget
    ...
    def __init__(
        ...
        self.turns_panel: "LetterBookTurnsPanel" = turns_panel
    ...
    def _setup_widgets(self) -> None:
        self.prop_rot_dir_button_manager = LetterBookPropRotDirButtonManager(self)
        self.header_widget = LetterBookTurnsBoxHeader(self)
        self.turns_widget = LetterBookTurnsWidget(self)
