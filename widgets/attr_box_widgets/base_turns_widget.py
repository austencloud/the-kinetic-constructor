...
if TYPE_CHECKING:
    from ..ig_tab.ig_filter_tab.by_color.ig_color_attr_box import IGColorAttrBox
    from ..ig_tab.ig_filter_tab.by_lead_state.ig_lead_state_attr_box import (
        IGLeadStateAttrBox,
    )
    from ..ig_tab.ig_filter_tab.by_motion_type.ig_motion_type_attr_box import (
        IGMotionTypeAttrBox,
    )
from ..attr_box_widgets.base_attr_box_widget import BaseAttrBoxWidget
from ..attr_box_widgets.attr_box_button import AttrBoxButton
