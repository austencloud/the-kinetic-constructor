        ...
        self.mock_main_widget.letters = {
            'A': [
                [
                    ...
                    {"color": "blue", "motion_type": "pro", "rotation_direction": "r", "quadrant": "sw", "start_location": "s", "end_location": "w", "turns": 0},
                    {"color": "red", "motion_type": "pro", "rotation_direction": "r", "quadrant": "ne", "start_location": "n", "end_location": "e", "turns": 0}
                ]
            ],
            'B': [
                [
                    {"start_position": "alpha2", "end_position": "alpha1"},
                    {"color": "blue", "motion_type": "anti", "rotation_direction": "r", "quadrant": "sw", "start_location": "w", "end_location": "s", "turns": 0},
                    {"color": "red", "motion_type": "anti", "rotation_direction": "r", "quadrant": "ne", "start_location": "e", "end_location": "n", "turns": 0}
                ]
            ],
            'C': [
                [
                    {"start_position": "alpha3", "end_position": "alpha4"},
                    {"color": "blue", "motion_type": "anti", "rotation_direction": "l", "quadrant": "ne", "start_location": "n", "end_location": "e", "turns": 0},
                    {"color": "red", "motion_type": "pro", "rotation_direction": "r", "quadrant": "sw", "start_location": "s", "end_location": "w", "turns": 0}
                ]
            ],
            'D': [
                [
                    {"start_position": "beta1", "end_position": "alpha2"},
                    {"color": "blue", "motion_type": "pro", "rotation_direction": "l", "quadrant": "nw", "start_location": "n", "end_location": "w", "turns": 0},
                    {"color": "red", "motion_type": "pro", "rotation_direction": "r", "quadrant": "ne", "start_location": "n", "end_location": "e", "turns": 0}
                ]
            ],
