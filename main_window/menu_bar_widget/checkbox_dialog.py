...
class CheckboxDialog(QDialog):
    def __init__(self, parent: 'QWidget', options: Dict[str, bool], callback: Callable[[str, bool], None]):
    ...
    def _setup_ui(self, options: Dict[str, bool]):
        ...
        for option, checked in options.items():
            ...
            checkbox.stateChanged.connect(lambda state, o=option: self.checkbox_toggled(o, state))
