...
class LayoutControlsWidget(QWidget):
    ...
    def _setup_components(self):
        ...
        self.default_layout_label = QLabel(
            f"Default: {self.layout_tab.beat_frame.current_layout[0]} x {self.layout_tab.beat_frame.current_layout[1]}",
            self,
        )
    ...
    def _apply_default_layout(self):
        ...
        self.update_default_layout_label(self.beat_frame.current_layout)
        self.settings_manager.sequence_layout.set_layout_setting(
            str(self.layout_tab.num_beats), list(self.beat_frame.current_layout)
        )
    ...
    def _on_sequence_length_spinbox_changed(self, new_length: int):
        ...
        self.beat_frame.current_layout = self.valid_layouts[0]
        self.num_beats_spinbox.setValue(self.layout_tab.num_beats)
