...
if TYPE_CHECKING:
    from main_window.main_widget.learn_widget.codex.codex_control_widget import CodexControlWidget
...
class CodexControlButton(QPushButton):
    ...
    def __init__(
        self,
        control_widget: "CodexControlWidget",
        icon_name: str,
        callback: Callable
    ):
        """
    ...
    def _setup_appearance(self) -> None:
        ...
        icon_path = get_images_and_data_path(
            f"{self.ICON_BASE_PATH}/{self.icon_name}"
        )
