    ...
    def set_orientation(self, orientation: str) -> None:
        ...
        if len(self.json_manager.loader_saver.load_current_sequence_json()) > 1:
            ...
            start_position_pictographs = (
                self.ori_picker_box.graph_editor.sequence_widget.main_widget.constructor_tab.start_pos_picker.pictograph_frame.start_positions
            )
            ...
            self.option_picker = (
                self.ori_picker_box.graph_editor.sequence_widget.main_widget.constructor_tab.option_picker
            )
            self.option_picker.update_option_picker()
        else:
            start_pos_picker = (
                self.ori_picker_box.graph_editor.sequence_widget.main_widget.constructor_tab.start_pos_picker
            )
            advanced_start_pos_picker = (
                self.ori_picker_box.graph_editor.sequence_widget.main_widget.constructor_tab.advanced_start_pos_picker
            )
