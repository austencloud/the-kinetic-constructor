...
from main_window.main_widget.construct_tab.option_picker.reversal_combobox import ReversalCombobox
...
class OptionPickerReversalSelector(QWidget):
    ...
    def resizeEvent(self, event):
        ...
        font = self.font()
        font_size = int(self.option_picker.manual_builder.main_widget.width() * 0.0075)
