...
from main_window.main_widget.dictionary_widget.variation_number_fixer import (
    VariationNumberFixer,
)
from main_window.main_widget.dictionary_widget.delete_confirmation_dialog import (
