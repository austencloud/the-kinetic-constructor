...
from main_window.main_widget.dictionary_widget.variation_number_fixer import VariationNumberFixer
from main_window.main_widget.dictionary_widget.delete_confirmation_dialog import DeleteConfirmationDialog
...
class DictionaryDeletionHandler:
    ...
    def delete_variation(self, thumbnail_box: "ThumbnailBox", index):
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            current_scroll_position = self.dictionary_widget.browser.scroll_widget.scroll_area.verticalScrollBar().value()
            ...
            def restore_scroll_position():
                self.dictionary_widget.browser.scroll_widget.scroll_area.verticalScrollBar().setValue(current_scroll_position)
