...
from main_window.main_widget.browse_tab.sequence_picker.sequence_picker_go_back_button import SequencePickerGoBackButton
...
class SequencePicker(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.currently_displaying_label = SequencePickerCurrentlyDisplayingLabel(self)
