...
class AddToDictionaryManager:
    ...
    def process_sequence(self, current_sequence):
        ...
        if not os.path.exists(base_path):
            os.makedirs(base_path)  # Create root folder for the word if it doesn't exist
    ...
    def save_variation(self, sequence, base_word, variation_number):
        ...
        self.thumbnail_generator.generate_and_save_thumbnail(sequence, variation_number, base_path)
