...
from main_window.main_widget.browse_tab.dictionary_browser.thumbnail_box.word_label import WordLabel
from main_window.main_widget.write_tab.act_browser.act_thumbnail_image_label import ActThumbnailImageLabel
