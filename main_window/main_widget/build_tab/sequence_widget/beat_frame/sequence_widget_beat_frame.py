...
from main_window.main_widget.build_tab.sequence_widget.beat_frame.start_position_adder import (
    StartPositionAdder,
)
from main_window.main_widget.build_tab.sequence_widget.sequence_widget_pictograph_factory import (
    BeatFactory,
)
