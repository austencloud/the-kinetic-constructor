...
class BeatSelectionOverlay(QWidget):
    ...
    def select_beat(self, beat_view: BeatView, toggle_graph_editor=True):
        if self.selected_beat == beat_view:
            ...
            graph_editor = (
                self.selected_beat.beat_frame.main_widget.build_tab.sequence_widget.graph_editor
            )
        ...
        if toggle_graph_editor:
            if (
                not self.beat_frame.main_widget.build_tab.sequence_widget.graph_editor.isVisible()
            ):
