...
from main_window.main_widget.build_tab.sequence_widget.beat_frame.layout_options_dialog import (
    LayoutOptionsDialog,
)
from main_window.main_widget.build_tab.sequence_widget.full_screen_viewer import (
    FullScreenViewer,
)
