...
if TYPE_CHECKING:
    from main_window.main_widget.build_tab.option_picker.advanced_start_pos_picker.advanced_start_pos_picker import (
...
class AdvancedStartPosPickerPictographFrame(QWidget):
    def __init__(self, advanced_start_pos_picker: "AdvancedStartPosPicker"):
        ...
        self.clickable_option_handler = (
            self.advanced_start_pos_picker.manual_builder.option_click_handler
        )
