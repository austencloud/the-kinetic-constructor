...
if TYPE_CHECKING:
    from main_window.main_widget.build_tab.option_picker.option_picker_reversal_selector import OptionPickerReversalSelector
...
class ReversalCombobox(QComboBox):
    ...
    def resizeEvent(self, event):
        ...
        font = self.font()
        font_size = int(
            self.reversal_selector.option_picker.manual_builder.build_tab.width() * 0.01
        )
