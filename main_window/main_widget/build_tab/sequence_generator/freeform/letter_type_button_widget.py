...
from main_window.main_widget.build_tab.sequence_widget.beat_frame.button_styled_border_overlay import (
    StyledBorderOverlayForButton,
)

if TYPE_CHECKING:
    from main_window.main_widget.build_tab.sequence_generator.freeform.letter_type_picker_widget import (
...
class LetterTypeButtonWidget(QWidget):
    ...
    def resizeEvent(self, event):
        ...
        font.setPointSize(self.letter_type_picker.generator_frame.height() // 10)
        font.setBold(True)
        self.label.setFont(font)
