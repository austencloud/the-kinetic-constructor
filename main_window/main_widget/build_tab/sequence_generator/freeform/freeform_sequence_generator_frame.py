...
from main_window.main_widget.build_tab.sequence_generator.freeform.freeform_sequence_generator import (
...
class FreeformSequenceGeneratorFrame(BaseSequenceGeneratorFrame):
    ...
    def on_create_sequence(self, overwrite_sequence: bool):
        if overwrite_sequence:
            self.sequence_generator_widget.main_widget.build_tab.sequence_widget.beat_frame.deletion_manager.delete_all_beats()
