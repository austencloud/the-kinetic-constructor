...
class FreeFormSequenceGenerator(BaseSequenceGenerator):
    ...
    def build_sequence(
        ...
        manual_builder = self.sequence_widget.main_widget.constructor_tab
    ...
    def _generate_next_pictograph(
        ...
        options = self.main_widget.constructor_tab.option_picker.option_getter._load_all_next_options(
            self.sequence
        )
