...
class Grid(QGraphicsSvgItem):
    ...
    def init_points(self, point_names, constants):
        return {constant: self.get_circle_coordinates(point_name) for point_name, constant in zip(point_names, constants)}

    def get_layer2_point(self, quadrant):
        point_names = ["ne_layer2_point", "se_layer2_point", "sw_layer2_point", "nw_layer2_point"]
