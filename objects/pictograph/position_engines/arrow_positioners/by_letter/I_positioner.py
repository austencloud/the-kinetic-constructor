    ...
    def _get_adjustments_dictionary(self) -> dict:
        ...
        adjustment_values = {
            ...
            (2.5, 1.5): [
                ((25, 50), (-50, 25), (-25, -50), (50, -25)),  # PRO CW
                ((-50, -25), (25, -50), (50, 25), (-25, 50)),  # PRO CCW
                ((-65, -85), (85, -65), (65, 85), (-85, 65)),  # ANTI CW
                ((85, 65), (-65, 85), (-85, -65), (65, -85)),  # ANTI CCW
            ],
            (2.5, 2): [
                ((75, -85), (85, 75), (-75, 85), (-85, -75)),  # PRO CW
                ((85, -75), (75, 85), (-85, 75), (-75, -85)),  # PRO CCW
                ((-80, 65), (-65, -80), (80, -65), (65, 80)),  # ANTI CW
                ((-65, 80), (-80, -65), (65, -80), (80, 65)),  # ANTI CCW
            ],
            (2.5, 2.5): [
                ((-105, 155), (-155, -105), (105, -155), (155, 105)),  # PRO CW
                ((-155, 105), (-105, -155), (155, -105), (105, 155)),  # PRO CCW
                ((-60, 105), (-105, -60), (60, -105), (105, 60)),  # ANTI CW
                ((-105, 60), (-60, -105), (105, -60), (60, 105)),  # ANTI CCW
            ],
            (2.5, 3): [
                ((75, -85), (85, 75), (-75, 85), (-85, -75)),  # PRO CW
                ((85, -75), (75, 85), (-85, 75), (-75, -85)),  # PRO CCW
            ...
            (3, 0): [
                ((75, -85), (85, 75), (-75, 85), (-85, -75)),  # PRO
                ((85, -75), (75, 85), (-85, 75), (-75, -85)),  # PRO
                ((50, -25), (25, 50), (-50, 25), (-25, -50)),  # ANTI
                ((25, -50), (50, 25), (-25, 50), (-50, -25)),  # ANTI
            ],
            (3, 0.5): [
                ((-45, -30), (30, -45), (45, 30), (-30, 45)),  # PRO CW
                ((30, 45), (-45, 30), (-30, -45), (45, -30)),  # PRO CCW
                ((-65, 80), (-80, -65), (65, -80), (80, 65)),  # ANTI CW
                ((-80, 65), (-65, -80), (80, -65), (65, 80)),  # ANTI CCW
            ],
            (3, 1): [
                ((75, -85), (85, 75), (-75, 85), (-85, -75)),  # PRO
                ((85, -75), (75, 85), (-85, 75), (-75, -85)),  # PRO
