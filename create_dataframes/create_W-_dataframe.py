...
class Create_X_Dash_Dataframe:
    ...
    def __init__(self) -> None:
        ...
        # Define pro motion combinations for cw and ccw
        shifts = {
            "cw": [("n", "e"), ("e", "s"), ("s", "w"), ("w", "n")],
            "ccw": [("n", "w"), ("w", "s"), ("s", "e"), ("e", "n")],
        }
        ...
        # Generate combinations with left in pro and right in dash
        ...
        # Generate combinations with left in dash and right in pro
        for letter, rotation_direction in product(letters, rotation_directions):
        ...
        comprehensive_df.to_csv(
            os.path.join(os.path.dirname(__file__), "W-DataFrame.csv"), index=False
        )
        print("W- DataFrame created and saved.")
